        ...
        <section className="hero-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          ...
          <div className="container relative z-10" style={{ color: "white" }}>
            ...
            <p className="animate-fade-in-up" style={{ fontSize: "1.125rem", maxWidth: "600px", opacity: 0.9, animationDelay: "0.1s" }}>
              News, product updates, and stories from the road.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <span className="split-eyebrow" style={{ color: "var(--color-indigo)", fontWeight: 700, textTransform: "uppercase", fontSize: "0.875rem", letterSpacing: "0.05em", display: "block", marginBottom: "16px" }}>Latest Posts</span>
              <h2 className="font-display" style={{ fontSize: "36px" }}>Read our latest updates</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>New App Features</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Learn about the latest safety and convenience features rolling out to the Riksho passenger app this month.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>⚡</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Our EV Transition</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Read how we are successfully converting 30% of our active fleet to electric vehicles by next year.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>🏆</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Partner Awards</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Celebrating our top-rated drivers across the country in our annual Riksho Partner Excellence Awards.</p>
              </div>
            </div>

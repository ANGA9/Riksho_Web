        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              ...
              <h2 className="font-display" style={{ fontSize: "36px" }}>Fast and secure delivery</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Request a pickup</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Tell us what you are sending and where it needs to go. We'll assign a nearby courier.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Hand over the parcel</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>The courier arrives at your door. Fast, secure, and hassle-free pickup.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Live tracking</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Track your package live on the map until it reaches the recipient safely.</p>
              </div>
            </div>

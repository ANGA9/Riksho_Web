        ...
        <section className="hero-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          ...
          <div className="container relative z-10" style={{ color: "white" }}>
            ...
            <p className="animate-fade-in-up" style={{ fontSize: "1.125rem", maxWidth: "600px", opacity: 0.9, animationDelay: "0.1s" }}>
              Features designed to keep you safe before, during, and after your trip.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <span className="split-eyebrow" style={{ color: "var(--color-indigo)", fontWeight: 700, textTransform: "uppercase", fontSize: "0.875rem", letterSpacing: "0.05em", display: "block", marginBottom: "16px" }}>For Passengers</span>
              <h2 className="font-display" style={{ fontSize: "36px" }}>Your safety toolkit</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Share My Trip</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Share your live location and driver details with trusted contacts so they can follow your ride.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Driver Verification</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Check the driver's photo, rating, and vehicle number before getting into the car.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Ride Tracking</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Our system monitors trips for unexpected long stops or route deviations and checks in on you.</p>
              </div>
            </div>
            ...
            <div style={{ position: "relative", width: "100%", height: "400px", margin: "0 auto", backgroundColor: "#f9fafb", borderRadius: "var(--radius-lg)", overflow: "hidden", border: "1px solid var(--admin-border)" }}>
              <Image 
                ...
                alt="Safety toolkit illustration"
                fill

        ...
        <section className="hero-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          ...
          <div className="container relative z-10" style={{ color: "white" }}>
            ...
            <p className="animate-fade-in-up" style={{ fontSize: "1.125rem", maxWidth: "600px", opacity: 0.9, animationDelay: "0.1s" }}>
              We're committed to keeping you safe while you keep the city moving.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              ...
              <h2 className="font-display" style={{ fontSize: "36px" }}>Driving safely together</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Verified Riders</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>We require riders to provide valid contact information, so you know who is getting in your vehicle.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Insurance Coverage</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Every active ride on the platform is covered by our partner insurance program for your peace of mind.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Partner Support</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Access our dedicated partner support line directly from the app whenever you need assistance.</p>
              </div>
            </div>
            ...
            <div style={{ position: "relative", width: "100%", height: "400px", margin: "0 auto", backgroundColor: "#f9fafb", borderRadius: "var(--radius-lg)", overflow: "hidden", border: "1px solid var(--admin-border)" }}>
              <Image 
                ...
                alt="Driver safety toolkit illustration"
                fill
